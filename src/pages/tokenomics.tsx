    ...
    <Layout title="CVM Tokenomics (Lite)">
      <section className="max-w-3xl mx-auto py-16 text-gray-200">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300">
          <li>Hard cap of 1,000,000,000 CVM</li>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300">
          <li>
            <strong>Wholesale:</strong> Convex Foundation sells larger allocations to qualified,
            accredited purchasers. Manual KYC. Coins are locked with a defined release schedule.
          </li>
          <li>
            <strong>Retail:</strong> Authorized reseller offers smaller amounts with no lock.
            Price reflects the current release curve and availability.
          </li>
        </ul>
